...
SDL_Window *render_init_window(u32 width, u32 height) {
    ...
    // Create my SDL window using OpenGL
...
void render_init_quad(u32 *vao, u32 *vbo, u32 *ebo) {
    ...
    // What order the vertices make up the triangle
    u32 indices[] = {
        0, 1, 3,
        1, 2, 3
    };
    ...
    // xyz (index, number of args, type, normalize, stride -> how many elements to move to get to the next group, offset)
